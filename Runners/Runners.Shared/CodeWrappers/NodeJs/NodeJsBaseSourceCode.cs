namespace Runners.Shared.CodeWrappers.NodeJs
{
    public static class NodeBaseSourceCode
    {
        public const string Source =
             ...
             try {
               ...
               Module.prototype.require = function(moduleName) {
                 try {
                   ...
                   // rethrow to make require fail fast if banned
                   throw e;
                 }
           ...
           /* RunnerHelpers (comparators and utilities) */
           const RunnerHelpers = {
             ...
             /**
              * assertCompare returns { ok: bool, reason?: string }
              * comparators: eq | neq | seq_eq | seq_eq_sorted | contains | lt | gt | le | ge
              */
           ...
           const __TestMonitor = {
             ...
             get: function() { return this._passed; }
           };
